...
public class Game2ContextManager : MonoBehaviour
{
	//Singleton of the CorsiContextManager class
	public static Game2ContextManager singleton = null;

	public GameObject contextizeObject;
    public GameObject frontalBackground;
	...
	private void PutContextCurtain()
	{
        ...
        frontalBackground.SetActive(false);
